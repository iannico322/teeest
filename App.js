  ...
  return (
    ...
    <NavigationContainer>
      ...
      <Stack.Screen options={{ headerShown: false ,customAnimationOnGesture:true,animation:"slide_from_bottom"} } name="Login" component={LoginPage} />
        ...
        <Stack.Screen options={{ headerShown: false,customAnimationOnGesture:true,animation:"slide_from_left"} }name="Dashboard" component={Dashboard} />
        <Stack.Screen options={{ headerShown: false,customAnimationOnGesture:true,animation:"slide_from_left"} }name="Profile" component={Profile} />
