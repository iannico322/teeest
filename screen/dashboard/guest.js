...
import {
  ...
  View,
  Image,
  SafeAreaView,StatusBar, TouchableHighlight,Text
} from "react-native";
...
export const Guest = ({ navigation }) => {
  ...
  return (
    ...
    <View  style={{position:"absolute",zIndex:3,right:0,margin:20}}>
            <TouchableHighlight style={{height:54,width:100,borderRadius:10,alignItems:"center",justifyContent:"center",backgroundColor:"red"}}
            onPress={
                ()=>{
